...
#get users and attributes$Users = Get-ADUser -Filter * -SearchBase "Ou=Bjornen,dc=bjornen,dc=sfv,dc=se" -Properties $Properties | sort -Property LastLogonDate -Descending
